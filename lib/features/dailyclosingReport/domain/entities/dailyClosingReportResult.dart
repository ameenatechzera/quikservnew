...
class DailyClosingReportResponse extends Equatable {
  ...
  List<Object?> get props => [
    status, error, message, summaryReport, expenseDetails, expenseTotal, cashBalance, bankBalance, ];
}
...
class ExpenseDetail extends Equatable {
  ...
  @override
  List<Object?> get props => [
    paymentMasterId, paymentNo, paymentDate, cashBankLedgerId, ledgerId, ledgerType, amount, narration, branchId, createdDate, createdUser, modifiedDate, modifiedUser, ledgerName, ];
}
...
class SummaryReports extends Equatable {
  ...
  @override
  List<Object?> get props => [
    invoiceDate, cashAmount, cardAmount, creditAmount, ];
}
