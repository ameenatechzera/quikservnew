...
class FetchMonthlyGraphReportUseCase implements UseCaseWithParams<MonthlyGraphReportResult, BarGraphRequest> {
  ...
  @override
  ResultFuture<MonthlyGraphReportResult> call(BarGraphRequest request) async => _generalRepository.fetchMonthlyGraphReport(request);
