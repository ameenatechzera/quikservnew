...
class SavePrinterSettingsRequest extends Equatable {
  const SavePrinterSettingsRequest({
  ...
  static const String kitchenBluetoothPrinterIdKey =
      "kitchenBluetoothPrinterId";
  ...
  static const String kitchenBluetoothPrinterNameKey =
  ...
  SavePrinterSettingsRequest copyWith({
    ...
    return SavePrinterSettingsRequest(
      ...
      mainBluettothPrinterId:
          mainBluettothPrinterId ?? this.mainBluettothPrinterId,
      kitchenBluetoothPrinterId:
          kitchenBluetoothPrinterId ?? this.kitchenBluetoothPrinterId,
      mainBluetoothPrinterName:
          mainBluetoothPrinterName ?? this.mainBluetoothPrinterName,
      kitchenBluetoothPrinterName:
          kitchenBluetoothPrinterName ?? this.kitchenBluetoothPrinterName,
      ...
      companyAddressVisible:
          companyAddressVisible ?? this.companyAddressVisible,
      companyPhonenoVisible:
          companyPhonenoVisible ?? this.companyPhonenoVisible,
