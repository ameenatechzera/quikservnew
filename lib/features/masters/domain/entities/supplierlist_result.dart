...
class SupplierListResponse extends Equatable {
  ...
  final List<SupplierList> details;
  static const String detailsKey = "details";


  SupplierListResponse copyWith({
    int? status,
    bool? error,
    String? message,
    List<SupplierList>? details,
  }) {
...
class SupplierList extends Equatable {
  ...
  factory SupplierList.fromJson(Map<String, dynamic> json){
    return SupplierList(
      id: json["id"] ?? 0,
  ...
  @override
  List<Object?> get props => [
    id, userType, username, password, isactive, name, createdDate, createdUser, modifiedDate, modifiedUser, ];
}
