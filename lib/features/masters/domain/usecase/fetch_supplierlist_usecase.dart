...
class FetchSupplierListUseCase
    implements UseCaseWithoutParams<SupplierListResponse> {
  final UserCreationRepository _userCreationRepository;

  FetchSupplierListUseCase(this._userCreationRepository);

  @override
  ResultFuture<SupplierListResponse> call() async =>
      _userCreationRepository.fetchSupplierList();
}
