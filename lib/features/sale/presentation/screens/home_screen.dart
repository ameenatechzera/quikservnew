...
// // ✅ ADD THIS (your shared preference + notifier)
...
//   final double _maxSwipeDistance = 200;
...
//   // ✅ LIVE setting value
//   int _itemTapBehavior = 1; // 1 = add qty, 2 = open dialog
//   late final VoidCallback _itemTapListener;
...
//       if (productName.contains(lowercaseQuery)) return true;

//       final productNameWithoutSpaces = productName.replaceAll(' ', '');
//       if (productNameWithoutSpaces.contains(queryWithoutSpaces)) return true;
...
//                     child: InkWell(
//                       borderRadius: BorderRadius.circular(20),
//                       onTap: _toggleMenuModeWithAnimation,
//                       child: Center(
//                         child: Icon(
//                           isMenuMode ? Icons.arrow_back : Icons.menu,
//                           color: AppColors.white,
...
//                 .read<SaleCubit>()
//                 .isSearchBarVisible;
//             final searchQuery = context.read<SaleCubit>().searchQuery;
...
//                                     // ✅ Your existing ADD/QTY overlay stays UNCHANGED (kept as in your code)

//                                     // ✅ PRICE BADGE should follow same tap behavior
//                                     ValueListenableBuilder<List<CartItem>>(
//                                       valueListenable: cartManager.cartItems,
//                                       builder: (context, cartItems, _) {
//                                         CartItem? cartItem;
