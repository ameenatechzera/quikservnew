class FetchAccountLedgerResponseEntity {
  final int? status;
  final bool? error;
  final String? message;
  final List<FetchAccountLedgerDetailsEntity>? ledgers;

  FetchAccountLedgerResponseEntity({
    this.status,
    this.error,
    this.message,
    this.ledgers,
...
class FetchAccountLedgerDetailsEntity {
  final int? ledgerId;
  ...
  FetchAccountLedgerDetailsEntity({
    this.ledgerId,
    this.ledgerName,
    this.groupId,
    this.billByBill,
