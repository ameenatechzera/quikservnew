...
class _AccGroupEntryScreenState extends State<AccountGroupEntryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CommonAppBar(title: st_title),
      body: Expanded(
                ...
                builder: (context, state) {
                  if (state is AccountGroupsLoaded) {
                    ...
                    if (selectedGroupId != null) {
                      try {
                        selectedGroup = state.accountGroups.firstWhere(
                    ...
                    return Padding(
                      ...
                      child: DropdownButtonFormField<AccountGroups>(
                        ...
                        items: state.accountGroups.map((group) {
              ...
              BlocConsumer<AccountGroupCubit, AccountGroupState>(
                listener: (context, state) {
                  if (state is SaveAccountGroupCompleted ||
                      state is UpdateAccountGroupCompleted) {
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: () {
                          ...
                          if (selectedGroupId == null) {
                            Fluttertoast.showToast(
                              msg: "Please select account group",
                            );
                            return;
                          }
                          if (st_title == 'Edit Group') {
                            context
                                ...
                                .updateAccountGroups(
                                  UpdateAccountGroupRequest(
                                    accountGroupCode: '',
                                    accountGroupName: _groupNameController.text
                                        .toString(),
                                    groupUnder: selectedGroupId!,
                                    narration: '',
                                    ledgerNextNo: '',
                                    branchId: '',
                                    modifiedUser: st_username.toString().trim(),
                            ...
                            context.read<AccountGroupCubit>().saveAccountGroups(
                              SaveAccountGroupRequest(
                                ...
                                ledgerNextNo: '',
                                branchId: '',
                                createdUser: st_username.toString().trim(),
                              ),
                            );
                          }
                        },
