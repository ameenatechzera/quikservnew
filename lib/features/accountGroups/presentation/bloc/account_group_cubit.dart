...
class AccountGroupCubit extends Cubit<AccountGroupState> {
  ...
  required DeleteAccountGroupUseCase deleteAccountGroupUseCase , required UpdateAccountGroupUseCase updateAccountGroupUseCase}) :
        _fetchAccountGroupsUseCase = fetchAccountGroupsUseCase, _saveAccountGroupUseCase = saveAccountGroupUseCase,
        _deleteAccountGroupUseCase = deleteAccountGroupUseCase , _updateAccountGroupUseCase = updateAccountGroupUseCase ,super(AccountGroupInitial());
